...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Data center utama di Jakarta dan Surabaya untuk traffic Indonesia, plus node di Singapore, Tokyo, dan Frankfurt untuk traffic global. Kami pilih lokasi terdekat secara otomatis berdasarkan asal pengunjung.',
  },
  {
    category: 'umum',
